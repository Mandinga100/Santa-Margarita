...
export default function WhatsAppFlotante() {
    ...
    return (
        <>
            ...
            <div className="hidden lg:flex fixed bottom-0 left-0 w-full bg-[#1A1A1A] text-white py-1.5 px-4 z-[98] text-center text-xs font-bold tracking-wider items-center justify-center gap-3 border-t border-white/5">
