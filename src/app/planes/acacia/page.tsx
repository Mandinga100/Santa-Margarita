...
import styles from './PlanAcacia.module.css';
import HeroCarousel from '@/components/HeroCarousel';

export const metadata: Metadata = {
  title: 'Plan Acacia - Elegancia en el Recuerdo | Funeraria Santa Margarita',
  description: 'Plan intermedio que incluye urna modelo Acacia, arreglos florales, y todos los servicios esenciales con un toque de distinción.',
};

export default function PlanAcaciaPage() {
  const servicios = [
    ...
    { icon: "local_florist", title: "Arreglo Floral" },
  ...
  const arcaImages = [
    { src: '/imgs/planes/acacia.png', alt: 'Urna Acacia' },
    { src: '/imgs/planes/orquidea.png', alt: 'Urna Acacia Detalle' },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#b8960c]/30 font-sans">
      <section className="relative h-[95vh] w-full flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-30 text-center px-6 max-w-5xl mx-auto mt-20">
          ...
          <p className="text-white/80 text-lg md:text-2xl font-light italic leading-relaxed max-w-3xl mx-auto mb-16 drop-shadow-lg">
            “Una despedida con la elegancia y calidez que representa la madera de Acacia, 
            brindando un homenaje respetuoso y completo en cada detalle.”
          </p>
      ...
      {/* SECCIÓN MODIFICADA: El Arca Acacia */}
