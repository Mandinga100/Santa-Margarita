...
export default function Home() {
  ...
  const handleContactSubmit = (e: React.FormEvent) => {
    ...
    const texto = encodeURIComponent(
      `Hola, soy *${nombre}*. Mi tel├®fono: ${telefono}.\n\n${mensaje || 'Solicito asesor├¡a funeral.'}`
    );
  ...
  return (
    <div className="bg-black">
      <style>{`
        ...
        /* Slogan plata brillante ANIMADO con borde negro y aura blanca din├ímica */
        .slogan-plata {
        ...
        @keyframes auraPulse {
          ...
          50% { 
            filter: 
              ...
              drop-shadow(1px -1px 0px rgba(0,0,0,1))
              drop-shadow(-1px 1px 0px rgba(0,0,0,1))
              /* Expansi├│n controlada del destello perif├®rico */
      ...
      >
        ...
        <div className="absolute inset-0 z-0 hero-parallax-bg w-full h-[120%] -top-[10%] ken-burns-wrapper">
          ...
          >
            {[
              ...
              { src: '/assets/images/otros/team1.webp', alt: 'Equipo de Atenci├│n' },
            ].map((img, i) => (
              <SwiperSlide key={i}>
        ...
        {/* Badge 24Hrs ÔÇô Centrado arriba (PASO 1) */}
        <div className="badge-24hrs-hero absolute top-[14%] left-[50%] -translate-x-1/2 z-30 flex items-center gap-2 px-5 py-2.5 cursor-default transition-all duration-300 whitespace-nowrap">
          ...
          <span className="text-[11px] font-black uppercase tracking-widest">Atenci├│n Permanente 24Hrs</span>
        </div>
        ...
        {/* CTAs Hero Restaurados ÔÇô Bottom Center (PASO 1) */}
        <div className="hero-ctas-bottom">
          ...
          >
            ...
            Previsi├│n Anticipada
          </Link>
        </div>
      </section>

      {/* ============================
          SECTION 2: PLANES FUNERARIOS ÔåÆ FONDO NEGRO (PASO 2)
      ============================== */}
      <section
        id="planes"
        ref={planesRef}
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <header className="text-center mb-20">
            ...
            <p className="text-white/50 text-lg font-light italic">Soluciones personalizadas seg├║n tus necesidades</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="plan-card-body">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-5">
                    <span className="text-[10px] font-black uppercase bg-[#25D366]/15 text-[#178540] px-3 py-1 rounded-full"><i className="fas fa-check mr-1" /> Asesor├¡a 24/7</span>
            ...
            <div className="card-plane plan-card" style={{ background: '#1a1a1a', position: 'relative' }}>
              ...
              <div className="plan-card-body" style={{ background: '#1a1a1a' }}>
                <div>
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="font-serif text-2xl italic text-white">Plan Ra├║l</h3>
      ...
      {/* ============================
          SECTION 3: SERVICIOS ÔåÆ FONDO BLANCO (PASO 2)
      ============================== */}
      <section
        id="servicios"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-[#1a1a1a]/60 text-xl font-light italic mb-12 leading-relaxed">
                Coordinamos cada detalle con discreci├│n y profesionalismo para que su familia pueda enfocarse en el recuerdo.
              </p>
      ...
      {/* ============================
          SECTION 4: MEMORIALES ÔåÆ FONDO NEGRO (PASO 2)
      ============================== */}
      <section
        id="memoriales"
        className="py-32 relative bg-[#1A1A1A] text-white"
      ...
      >
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-white/50 text-xl font-light italic max-w-3xl mx-auto mb-16">
            Espacios dise├▒ados para el recuerdo eterno. Honra la memoria de tus seres queridos con un memorial digital ├║nico.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
            {[
              ...
              { src: '/assets/images/otros/acacia3.webp', label: 'Jard├¡n Memorial' },
            ].map((item, i) => (
      ...
      {/* ============================
          SECTION 5: NOSOTROS ÔåÆ FONDO BLANCO (PASO 2)
      ============================== */}
      <section
        id="nosotros"
        className="py-32 relative bg-white text-[#1A1A1A]"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <header className="text-center mb-20">
            ...
            <p className="text-[#1a1a1a]/60 text-xl font-light italic max-w-3xl mx-auto">
              Custodiamos historias de vida con una veneraci├│n absoluta, uniendo la tradici├│n m├ís respetuosa con la innovaci├│n de vanguardia.
            </p>
            <div className="w-16 h-px bg-[#b8960c]/60 mx-auto mt-8" />
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              { icon: 'favorite', title: 'Respeto', desc: 'Entendemos la profundidad del duelo humano y actuamos con la m├íxima discreci├│n y empat├¡a.' },
              { icon: 'auto_awesome', title: 'Excelencia', desc: 'Buscamos la perfecci├│n est├®tica y operativa en cada ceremonia que coordinamos.' },
            ].map((v, i) => (
      ...
      {/* ============================
          SECTION 6: PREVISI├ôN ÔåÆ FONDO NEGRO (PASO 2)
      ============================== */}
      <section
        id="prevision"
        className="py-32 relative bg-[#1A1A1A] text-white"
        aria-label="Previsi├│n Familiar"
      >
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-white/50 text-xl font-light italic mb-12 leading-relaxed">
                  &ldquo;Un legado se construye con amor, pero se protege con previsi├│n.&rdquo;
                </p>
              ...
              <div className="grid gap-6">
                {[
                  { icon: 'lock', title: 'Precios Congelados', desc: 'Proteja su patrimonio de la inflaci├│n futura. El costo pactado hoy se mantiene vigente.' },
                  { icon: 'family_restroom', title: 'Tranquilidad Familiar', desc: 'Evite que los suyos enfrenten decisiones complejas en el momento m├ís vulnerable.' },
                  { icon: 'spa', title: 'Voluntad Respetada', desc: 'Dise├▒e hoy su homenaje p├│stumo seg├║n sus valores y preferencias.' },
                ].map((b, i) => (
      ...
      {/* ============================
          SECTION 7: CONFIANZA ÔåÆ FONDO BLANCO (PASO 2)
      ============================== */}
      <section
        id="confianza"
        className="py-32 relative bg-white text-[#1A1A1A]"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                { icon: 'fa-medal', label: 'A├▒os de Excelencia', target: '30', suffix: '', prefix: '' },
                { icon: 'fa-star', label: 'Satisfacci├│n', target: '100', suffix: '%', prefix: '' },
              ].map((s, i) => (
            ...
            <div>
              ...
              >
                {[
                  {
                    name: 'Familia Rodr├¡guez Vargas',
                    img: '/assets/images/ui/avatars-ia/avatar-testimonio-femenino.webp',
                    text: 'En el momento m├ís dif├¡cil, Santa Margarita fue un faro de luz. Dignidad y respeto en cada detalle.',
                  },
                  {
                    name: 'Roberto Echeverr├¡a',
                    img: '/assets/images/ui/avatars-ia/avatar-testimonio-masculino.webp',
                    text: 'El plan Ra├║l super├│ toda expectativa. Discreci├│n y honor en cada momento.',
                  },
                ].map((t, idx) => (
                  <SwiperSlide key={idx}>
                    <div className="flex flex-col items-center text-center p-6">
                      ...
                      <cite className="text-[10px] font-black uppercase tracking-[0.4em] text-[#1a1a1a]/40 not-italic">ÔÇö {t.name}</cite>
                    </div>
                  </SwiperSlide>
                ))}
              </Swiper>
      ...
      {/* ============================
          SECTION 8: CONTACTO ÔåÆ FONDO NEGRO
      ============================== */}
      <section
        id="contacto"
        className="py-32 relative bg-[#0a0a0a]"
        aria-label="Contacto y Asesor├¡a"
      >
        <div className="max-w-5xl mx-auto px-6 text-center text-[#f5f0eb] mb-16">
          ...
          <p className="text-white/50 text-lg font-light italic max-w-2xl mx-auto">
            Nuestro equipo aguarda para brindarle contenci├│n inmediata en este momento.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="rounded-[2.5rem] p-10 md:p-14 border border-white/10 bg-white/[0.03] relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-center text-2xl text-white font-serif italic mb-10">Asesor├¡a Personalizada 24/7</h2>
              <form className="grid grid-cols-1 md:grid-cols-2 gap-5" onSubmit={handleContactSubmit} noValidate>
                ...
                <div className="md:col-span-2">
                  <textarea
                    className="w-full px-5 py-4 rounded-xl text-sm bg-white/5 border border-white/10 text-white placeholder-white/30 focus:outline-none focus:border-[#b8960c] transition-colors"
                    rows={4}
                    placeholder="Cu├®ntanos tu necesidad..."
